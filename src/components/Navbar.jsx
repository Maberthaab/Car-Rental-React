...
export default function Navbar() {
  ...
  return (
    <nav className="navbar navbar-expand-xl car-navbar position-sticky top-0">
      <div className="container-fluid car-container">
        <Link
          className="navbar-brand car-navbar__logo"
          to="/"
          aria-label="Binar Car Rental"
        ></Link>
        <button
          className="navbar-toggler car-toggler"
          type="button"
          ...
          <div className="offcanvas-body py-1 py-lg-0">
            <ul className="navbar-nav ms-auto navbar-nav-scroll">
              ...
              <li className="nav-item">
                <button type="button" className="btn btn-success car-button">
                  Register
                </button>
              </li>
            </ul>
