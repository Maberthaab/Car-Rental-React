...
export default function Testimonials() {
  const options = {
    ...
    margin: 20,
    nav: true,
    navClass: ["car-owl-prev", "car-owl-next"],
    navText: [
  ...
  return (
    <section id="testimonial">
      <div className="container-fluid car-container px-md-0">
        <div className="testimonials text-center">
          <h2 className="fw-bold car-title">Testimonial</h2>
          <p className="my-4">
            Berbagai review positif dari para pelanggan kami
          </p>
          <OwlCarousel className="car-owl" {...options}>
            {testiData.map((item, index) => (
              <div
                className="rounded-4 text-center d-flex flex-column flex-lg-row align-items-center p-5 car-bg-secondary"
                key={index}
              >
                <img
