export default function Faq() {
    ...
    return (
      <section id="faq">
        <div className="container-fluid car-container mx-auto row row-cols-1 row-cols-lg-2">
          <div className="col col-lg-5 text-center text-lg-start">
            <h4 className="fw-bold car-title">Frequently Asked Question</h4>
            <p className="car-fs-14">
